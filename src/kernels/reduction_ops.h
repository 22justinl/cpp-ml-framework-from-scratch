...
std::shared_ptr<TensorImpl> max(std::shared_ptr<const TensorImpl> a, size_t dim = SIZE_T_MAX);
std::shared_ptr<TensorImpl> min(std::shared_ptr<const TensorImpl> a, size_t dim = SIZE_T_MAX);
}
